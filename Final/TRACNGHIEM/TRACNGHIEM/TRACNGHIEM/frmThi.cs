    ...
    public partial class frmThi : Form
    {
        ...
        private void insertdiemsv()
        {
            String sql = "UPDATE dbo.BANGDIEM SET DIEM = " + diem +
                "WHERE MASV = '" + Program.mlogin//Program.mSV
