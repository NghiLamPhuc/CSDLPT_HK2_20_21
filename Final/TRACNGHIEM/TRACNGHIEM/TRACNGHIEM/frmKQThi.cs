...
namespace TRACNGHIEM
{
    public partial class frmKQThi : Form
    {
        ...
        private void frmKQThi_Load(object sender, EventArgs e)
        {
            ...
            String sql = "SELECT LOP.MALOP, LOP.TENLOP FROM SINHVIEN SV inner join LOP ON(SV.MASV='" + Program.mlogin + "' AND SV.MALOP = lOP.MALOP)";
            ...
            try
            {
                ...
                this.sP_MonHocSVTableAdapter.Fill(this.tNDataSet.SP_MonHocSV, Program.mlogin);
                if (sPMonHocSV.Count > 0)
                {
                    cbbMHSV.SelectedIndex = 0;
                    this.sP_LanThiSVTableAdapter.Connection.ConnectionString = Program.connstr;
                    this.sP_LanThiSVTableAdapter.Fill(this.tNDataSet.SP_LanThiSV, Program.mlogin, cbbMHSV.SelectedValue.ToString());
                    if (sPLanThiSV.Count > 0)
                    {
                        cbbLThi.SelectedIndex = 0;
                        String sqlNgayThi = "SELECT BANGDIEM.NGAYTHI FROM BANGDIEM WHERE BANGDIEM.MASV = '" + Program.mlogin + "' AND BANGDIEM.MAMH = '" + cbbMHSV.SelectedValue.ToString() + "'  AND BANGDIEM.LAN = '" + cbbLThi.SelectedValue.ToString() + "' ";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            this.sP_INBAITHITableAdapter.Fill(this.tNDataSet.SP_INBAITHI, Program.mlogin, cbbMHSV.SelectedValue.ToString(), short.Parse(cbbLThi.SelectedValue.ToString()));
        }

        private void btnInDSBD_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            rpKQTHI rpKQT = new rpKQTHI(Program.mlogin, cbbMHSV.SelectedValue.ToString(), short.Parse(cbbLThi.SelectedValue.ToString()));
