    ...
    public partial class frmDangNhap : Form
    {
        ...
        private void btnDangNhap_Click(object sender, EventArgs e)
        {
            ...
            if (radSinhVien.Checked)
            {
                ...
                String sql = "EXEC SP_KTSV_DANGNHAP '" + Program.mlogin + "'";
            ...
            else
            {
                ...
                strLenh = "EXEC SP_LAY_TT_DANGNHAPSV  '" + Program.mlogin + "'";
            }
            ...
            else
            {
                ...
                if (radSinhVien.Checked)
                {
                    ...
                    Program.frmSinhVienMain.MASO.Text = "Mã số: " + Program.mlogin;
        ...
        private void frmDangNhap_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string chuoiketnoi = "Data Source=NGHILAAM\\NGHILAM_SERVER2;Initial Catalog=TN;Integrated Security=True";
